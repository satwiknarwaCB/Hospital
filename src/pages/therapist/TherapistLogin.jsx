            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-neutral-100">
                    ...
                    <div className="mt-6 p-4 bg-secondary-50 rounded-xl border border-secondary-100">
                        <p className="text-xs font-medium text-secondary-700 mb-2">Demo Credentials:</p>
                        <div className="space-y-1">
                            <p className="text-xs text-secondary-600">
                                <span className="font-medium">Dr. Rajesh Kumar:</span> dr.rajesh@neurobridge.com / therapist123
                            </p>
                            <p className="text-xs text-secondary-600">
                                <span className="font-medium">Dr. Meera Singh:</span> dr.meera@neurobridge.com / therapist123
                            </p>
                        </div>
                    </div>
                </div>
