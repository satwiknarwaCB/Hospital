...
class SessionBase(BaseModel):
    ...
    location: Optional[str] = Field(None, description="Physical or virtual location for room utilization tracking")

    # Outcome Data (generated by AI, persisted for reports & analytics)
    measurableOutcomes: Optional[List[str]] = Field(default_factory=list, description="Quantifiable therapy outcomes")
    nonMeasurableOutcomes: Optional[List[str]] = Field(default_factory=list, description="Qualitative therapy observations")
    healthStatus: Optional[str] = Field(None, description="Child health condition during session")
...
class SessionUpdate(BaseModel):
    ...
    measurableOutcomes: Optional[List[str]] = None
    nonMeasurableOutcomes: Optional[List[str]] = None
