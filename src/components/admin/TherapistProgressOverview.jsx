...
const TherapistProgressOverview = () => {
    ...
    const generateClinicalPDF = (therapist, child, detail) => {
        ...
        doc.text('This is a formal hospital document generated by  Clinical Governance. All data is verified.', 20, 280);
        doc.text(' HOSPITAL | INTERNAL CASE STUDY | PAGE 1', 140, 280);
    ...
    const generateTherapistAuditPDF = (therapist) => {
        ...
        try {
            ...
            doc.setFontSize(10);
            doc.setFont('helvetica', 'normal');
            doc.text(' Hospital Governance Protocol', 20, 30);
